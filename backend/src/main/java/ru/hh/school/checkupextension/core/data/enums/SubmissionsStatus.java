...
public enum SubmissionsStatus {
    ...
    SubmissionsStatus(byte code) { this.statusCode = code; }

    public byte getCode() { return this.statusCode; }
    public String getTitle() { return this.toString(); }

    @Override
    public String toString() { return statuses.get(this.statusCode); }
}
